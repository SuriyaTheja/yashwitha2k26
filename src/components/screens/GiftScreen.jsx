            ...
            >
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-base md:text-lg text-primary/80">
                  I hope <span className="font-bold">నువ్వు బాగా ఉన్నినావు, బాగున్నావు, బాగుండాలి...</span><br />
                  Once again Happy Birthday..🎂 MoodSwinger, Over-thinker, Rough & Tough Girl! <br />
                  Hope you liked this..🎂✨
                </p>
